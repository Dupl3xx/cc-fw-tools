...
- [Oprava identity firmware pro Slicer](oc-patches/cc1-app/spoof-slicer-firmware-version/README-CZ.md)
- [Slicer firmware identity fix](oc-patches/cc1-app/spoof-slicer-firmware-version/README.md)
